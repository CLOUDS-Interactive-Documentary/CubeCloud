...
This Visual System is a 2D square of bins that randomly fill up. These bins project into the 3rd dimention as they fill up and when "full", continue to "fill up" with emptiness, and cycle indefinitely. The system tries to illustrate the underlying property of Randomness to have a Uniform distribution. The bins stay in sync for a few cycles before the cube becomes a uniform, consistent density for the rest of time.
